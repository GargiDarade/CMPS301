// C++ implementation of the Group Exercise 5
...
int main()
{
    ...
    if (operation.compare("addition") == 0)
    {
        ...
        cout << "\nYour answer is: "<<res;
        //static_cast is used
        cout << "\nYour answer in int form is: "<<static_cast<int>(res);
    ...
    else if (operation.compare("division") == 0)
    {
        ...
        //static_cast is used
        cout << "\nYour answer in int form is: "<<static_cast<int>(res)<< " and your remainder in int form is : " <<static_cast<int>(fmod(n1,n2));
    }
    else
    {
